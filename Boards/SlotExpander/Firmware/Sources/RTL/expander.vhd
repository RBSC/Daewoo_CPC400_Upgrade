...
-- Daewoo Slot Expander Firmware v1.01
...
begin
	...
	-- BUSDIR logic for subslots (if installed devices have BUSDIR driving capability - revision 1.1 of RAM expander)
	BUSDIR_N <= '0' when (BUSDIRI_N(1 downto 0)/="11")
										or (M1_N = '1' and IORQ_N = '0' and RD_N = '0' and A(7 downto 4) = "1111" and A(3) = '0' and A(2) = '1' and A(1 downto 0) = "00" ) else '1';

	-- The below code is a fix for the v1.00 of the Daewoo RAM module that doesn't have BUSDIR functionality
